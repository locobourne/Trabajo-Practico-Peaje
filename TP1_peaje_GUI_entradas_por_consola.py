#-----------------------------------------------------------------------------------------------------------------------
 # Cabina de peaje 1.1 version PySimpleGUI (entradas via consola).
...
tipo_de_vehiculo = int(input("Indique el tipo de vehiculo con un\n0) Para moto \n1) Para auto \n2) Para camion\n"))
metodo_de_pago = int(input("Indique la forma de pago:\n1) Manual\n2) Telepeaje\n"))
pais_ubicacion_peaje = int(input("Marque el pais en que se encuentra:\n0) Argentina\n1) Bolivia\n2) Brasil\n3) Paraguay\n4) Uruguay\n"))
distancia = float(input("Ingrese la distancia recorrida desde la ultima cabina de peaje, si es la primera marque 0:"))
...
print("----------------- Bienvenido al peaje de: " + pais + " -----------------")
print("* Patente: " + patente)
print("* Procedencia del vehiculo: " + nacionalidad)
print("* Tipo de vehiculo: " + vehiculo + ".")
print("------------------------------------------------------------------------")
print("          ")
print("=> El importe a pagar por: "  + vehiculo + " es de: " + str(descuento_vehiculo) + " $ ARS.")
print(telepeaje)
print("=> Total a pagar: " + str(monto_total) + " $ ARS.")
...
n8= valor_promedio
n0= "            "
psg.popup_scrolled(n1,n2,n3,n4,nn,n0,n5,n0,n6,n0,n7,n0,n8 ,title="Ticket: Cabina de peaje.")
